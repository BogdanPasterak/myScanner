...
public class MS3TestGetString {
	...
	public static void main(String[] args) throws IOException {
		...
		testS = MS3.getString("", MS3.ALLOW_FILL);
		...
		testS = MS3.getString("Type something", MS3.ALLOW_FILL);
		if (allTest = oneOf(testS, allTest, testS))
			System.out.println(testS + "\nPass");
		else
			System.out.println("\nFail   output = " + testS);
		...
		testS = MS3.getString("Type something", MS3.DONT_FILL);
		if (allTest = oneOf(testS, allTest, "Z"))
			System.out.println(testS + "\nPass");
		else
			System.out.println("\nFail   output = " + testS);
		...
		testS = MS3.getString("Type Yes, No or Cancel", MS3.STRINGS.YES_NO_CANCEL);
		if (allTest = oneOf(testS, allTest, "No"))
			System.out.println(testS + "\nPass");
		else
			System.out.println("\nFail   output = " + testS);
		...
		testS = MS3.getString("Type Yes, No or Cancel", MS3.DONT_FILL, MS3.STRINGS.YES_NO_CANCEL);
		if (allTest = oneOf(testS, allTest, "Yes"))
		...
		testS = MS3.getString("Type Yes or No", MS3.DONT_FILL, MS3.STRINGS.YES_NO);
		if (allTest = oneOf(testS, allTest, "Yes"))
			System.out.println( "y  !! change to " + testS + "\nPass");
		else
			System.out.println("\nFail   output = " + testS);
		...
		testS = MS3.getString("Type A or B", "A", "B");
		...
		testS = MS3.getString("Type A or B");
		if (allTest = oneOf(testS, allTest, testS))
			System.out.println( testS + "\nPass");
		else
			System.out.println("\nFail   output = " + testS);
		...
		testS = MS3.getString(MS3.DONT_FILL);
		if (allTest = oneOf(testS, allTest, "C"))
			System.out.println( testS + "\nPass");
		else
			System.out.println("\nFail   output = " + testS);
